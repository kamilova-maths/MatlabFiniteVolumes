...
u0t = 2*(lam.*dX)/((A(1)-2*D+A(1))).*P/(3*D);
...
% What in the world is the difference between u(1) and u0t ? They are
% *supposed* to be the exact same thing, K. 
