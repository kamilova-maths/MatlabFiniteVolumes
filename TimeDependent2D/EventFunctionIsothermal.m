...
% DATE:  2020
%
% DESCR:    [value, isterminal, direction] = EventFunctionIsothermal(t,y)
...
%           coupledPdeWithdPdtIsothermal

global K

    if y(K+1)<0.01 % if P is less than this tolerance value, then indicator is zero.
        value = 0; 
    else
