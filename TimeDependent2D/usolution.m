...
global K Gamma St D uf
    ...
    fu(1) = fu(1) - 2*P0t*lam*Atmp(1)*tiph(1)/(3*D*dx);  % include derivative (again, Neumann BC)
    %fu(1) = fu(1) - P0t*lam*Atmp(1)*tiph(1)/(3*D*dx);  % include derivative (again, Neumann BC)
