function eigVals = LinearStabilityFun(th0,A0,u0,gamma,Pe,Bi,St,L,x1,x2,plt,tha,numeigens) 
% Find steady state
...
eigVals = eigs(SS,P1,numeigens,100); 
 
 if plt==1
    figure;
  % plot the eigenvalues
    set(0,'DefaultAxesFontSize',12,'DefaultTextInterpreter','latex');
    plot(eigVals,'o', 'MarkerFaceColor', 'b')
